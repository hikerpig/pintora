...
export default function Header() {
  return <div className="Header flex justify-between px-3 py-3 shadow">
    <div>
    ...
    <div className="flex">
      <a href={DOC_URL} className="Header__link">Documentation</a>
      <a href={GITHUB_URL} className="Header__link">Github</a>
    </div>
  </div>
}
