import { ConnectorSemantic, FrameSemantic, MarkAttrs, MarkSemantic, SymbolSemantic } from '@pintora/core'
...
export type FrameOp = {
  ...
  height: number
  layer: ShapeLayer
  semantic: MarkSemantic & { frame: FrameSemantic }
  fallbackOps: SegmentOp[]
}
...
export type DrawOp = SegmentOp | RectOp | ConnectorOp | SymbolOp | FrameOp | TextOp
