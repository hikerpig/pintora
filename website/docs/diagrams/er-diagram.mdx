...
1. id `entity-{name}` for one specific entity
2. class `er__entity` for all entities
2. class `er__relationship-label` for all relation labels
...
erDiagram
  ...
  @bindClass entity-DELIVERER people
```
