...
[pintora-stencil - Pintora Web Components](https://github.com/hikerpig/pintora-stencil), this project comes with web component for showing pintora diagram preview, add it into your website simply by import some script tags.

<CodePen codePenId="xxYwXWM" tabs={['html', 'result']} clickToRun={true} />
